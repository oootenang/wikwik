...
const connectKeWA = () => {
const semar = makeWASocket({logger:pino({level:'silent'}),printQRInTerminal: true,auth: state,browser: ["Cristian", "Dekstop", "3.0"]})
...
msg = denz.messages[0]
nomorOwner = ['6283848574563','6288215743229']
nomorDeveloper = ['6283848574563']
